...
if len(x) == 0:
    print(f"Error: No benchmark data found for grpc_append_with_readers_bench")
    print(f"Expected to find data in: target/criterion/grpc_append_4readers/*/new/")
    print(f"Please run the benchmark first: make bench-append-with-readers")
    exit(1)
