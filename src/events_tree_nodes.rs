...
impl EventLeafNode {
    ...
    pub fn pop_last_key_and_value(&mut self) -> LmdbResult<(Position, EventValue)> {
...
impl EventInternalNode {
    ...
    pub fn split_off(&mut self) -> LmdbResult<(Position, Vec<Position>, Vec<PageID>)> {
