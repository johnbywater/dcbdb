...
for t in threads:
    est_path = Path(f"target/criterion/grpc_append_cond/{t}/new/estimates.json")
...
plt.title('DCBDB gRPC append with conditional (per-writer tag + after=head): throughput vs clients')
